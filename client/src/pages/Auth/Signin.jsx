...
export default function Signin() {
  ...
  const onPress = async (e) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.error || err.response?.data?.message || err.message || "An error occurred during sign in";
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 via-white to-indigo-50 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 sm:p-10 border border-gray-100">
            ...
            {/* Form */}
            <form onSubmit={onPress} className="space-y-6">
              <div>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  {/* <a href="#" className="text-sm font-medium text-customColor hover:text-indigo-600 transition-colors duration-200">
                      Forgot password?
                    </a> */}
                </div>
                <div className="relative">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link to="/signup" className="font-semibold text-customColor hover:text-indigo-600 transition-colors duration-200">
                  Sign up
                </Link>
              </p>
            </div>
